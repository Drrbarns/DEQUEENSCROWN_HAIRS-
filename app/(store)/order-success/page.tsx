        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 text-center mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Link
                ...
                className="bg-peach-600 hover:bg-peach-700 text-white px-8 py-4 rounded-lg font-semibold transition-colors inline-flex items-center justify-center whitespace-nowrap"
              >
          ...
          <div className="mt-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link href="/shipping" className="text-gray-900 hover:text-gray-900 font-semibold whitespace-nowrap">
