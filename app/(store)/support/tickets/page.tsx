            ...
            <div className="space-y-4">
              {filteredTickets.map((ticket) => (
                <Link
                  ...
                  className="block bg-white rounded-xl shadow-sm p-6 hover:shadow-lg transition-all border-2 border-transparent hover:border-gray-900"
                >
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="w-12 h-12 flex items-center justify-center bg-gray-100 rounded-lg mb-4">
                <i className="ri-checkbox-circle-line text-2xl text-gray-900"></i>
              </div>
