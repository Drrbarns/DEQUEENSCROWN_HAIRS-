  ...
  return (
    <html lang="en">
      ...
      <body className="antialiased font-sans overflow-x-hidden">
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[10000] focus:px-6 focus:py-3 focus:bg-peach-600 focus:text-white focus:rounded-lg focus:font-semibold focus:shadow-lg"
        >
