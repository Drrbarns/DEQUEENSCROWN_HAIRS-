  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50 safe-area-bottom">
      <div className="grid grid-cols-5 h-16">
        <Link
          href="/"
          className={`flex flex-col items-center justify-center space-y-1 transition-colors ${isActive('/') ? 'text-peach-600' : 'text-gray-600'
            }`}
        >
        ...
        <Link
          href="/shop"
          className={`flex flex-col items-center justify-center space-y-1 transition-colors ${isActive('/shop') ? 'text-peach-600' : 'text-gray-600'
            }`}
        >
          <div className="w-6 h-6 flex items-center justify-center">
        ...
        <Link
          href="/cart"
          className={`flex flex-col items-center justify-center space-y-1 transition-colors relative ${isActive('/cart') ? 'text-peach-600' : 'text-gray-600'
            }`}
        >
        ...
        <Link
          href="/wishlist"
          className={`flex flex-col items-center justify-center space-y-1 transition-colors relative ${isActive('/wishlist') ? 'text-peach-600' : 'text-gray-600'
            }`}
        >
          <div className="w-6 h-6 flex items-center justify-center relative">
        ...
        <Link
          href="/account"
          className={`flex flex-col items-center justify-center space-y-1 transition-colors ${isActive('/account') ? 'text-peach-600' : 'text-gray-600'
            }`}
        >
          <div className="w-6 h-6 flex items-center justify-center">
